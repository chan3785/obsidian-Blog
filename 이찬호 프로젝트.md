...
2. 게시글 생성/조회/수정/삭제: nestJS로 구성된 백엔드 로직으로 프론트엔드 구현
3. 트위터 agent 봇: zerepy를 사용해서 새로 업로드 되는 게시글을 요약 후 @rollsearch_bot 계정에 업로드
4. 토론 진행 페이지: agent 룸 id를 사용해 저장되는 message로 토론이 진행되는 것 프론트에서 구현
...
**링크:** [Website](https://squarebox-knkjg38li-akinobu-onos-projects.vercel.app/) | [GitHub](https://github.com/aki-0517/Squarebox.git)
